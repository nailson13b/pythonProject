...
print("Content Description: ", ele_id.get_attribute("content-desc"))
print("Text: ", ele_id.text)
print("Text: ", ele_id.get_attribute("text"))
time.sleep(2)
ele_id.click()
time.sleep(2)

ele_classname = driver.find_element_by_xpath("//android.widget.EditText[@text='Enter some Value']")
ele_classname.send_keys("Hello")
time.sleep(2)
ele_classname.clear()